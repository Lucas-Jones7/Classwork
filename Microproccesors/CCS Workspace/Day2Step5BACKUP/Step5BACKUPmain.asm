...
main:
			...
			mov.w	#2710h, R10				; step size for step 5 (10,000d)
			mov.w	#3A98h, R11				; min speed
			mov.w	#85000, R12				; max speed
...
SW2_Pressed:
			mov.w	#0000h, R7				; re-set R7 for check
			sub.w	R10, R9					; R8 -= step
			bic.b   #BIT3, &P2IFG           ; clear flag
			reti							; return to caller
