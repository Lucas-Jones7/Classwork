...
public class shapedemo {
	...
	public static void main(String[] args) {
		...
		System.out.println("Square Perimiter: " + s.perimeter() + " Area: " + s.area());
		...
		RegularHexagon h = new RegularHexagon(side_length);
		System.out.printf("Hexagon Perimeter: %.2f Area: %.2f", h.perimeter(), h.area());
