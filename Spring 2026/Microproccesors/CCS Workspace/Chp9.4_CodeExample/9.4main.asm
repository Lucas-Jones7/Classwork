...
;-------------------------------------------------------------------------------
init:
			bis.b	#BIT0, &P1DIR			; Set P1.0 as an output
			bic.b	#BIT0, &P1OUT			; set intial value of LED1 to 0
			...
			bic.b	#LOCKLPM5, &PM5CTL0		; disable high z option
...
toggle_LED1:
			xor.b	#BIT0, &P1OUT			; toggle P1.1 by xor'ing with 1
